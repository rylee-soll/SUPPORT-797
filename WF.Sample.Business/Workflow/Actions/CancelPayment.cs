...
public class CancelPayment : IAction
{
    public CancelPayment(IPaymentRepository payments)
    {
        _payments = payments;
    }
    ...
    {
        return _payments.SetState(processInstance.ProcessId, PaymentState.Canceled);
    }
